...
class ContactForm(ModelForm):
    class Meta:
        ...
        widgets = {
            'name'   : TextInput(attrs={'class': 'input','placeholder':'Name & Surname', 'required':'required'}),
            'subject' : TextInput(attrs={'class': 'input','placeholder':'Subject','required':'required'}),
            'email'   : TextInput(attrs={'class': 'input','placeholder':'Email Address','required':'required'}),
